...
public class StackWithMaxImproved {
    ...
    /* Helper class to keep the pair of max and the number of copies of the max. */
    ...
    public static class Stack {
        private Deque<Integer> element = new LinkedList<>(); // the stack
        private Deque<MaxWithCount> cachedMaxWithCount = new LinkedList<>(); // the stack maintaining max, count
