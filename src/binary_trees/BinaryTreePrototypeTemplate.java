        ...
        public String toString() {
            ...
            for (int i = 0; i < levels.size() - 1; i++) {
                ...
                for (BinaryTreeNode<T> node : thisLevel) {
                    result.add(node.left != null ? (node.left.data == null ? ("" + nodeID++) : node.left.data.toString()) : "#");
                    result.add(node.right != null ? (node.right.data == null ? ("" + nodeID++) : node.right.data.toString()) : "#");
                }
            }
